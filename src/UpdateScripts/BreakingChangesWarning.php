...
namespace DoubleThreeDigital\CookieNotice\UpdateScripts;
...
class BreakingChangesWarning extends UpdateScript
{
    ...
    public function update()
    {
        ...
        if (File::exists(resource_path('views/vendor/cookie-notice'))) {
            dump("[Cookie Notice] BREAKING CHANGE: Please re-publish the Cookie Notice view. See v5.0.0 changelog. https://github.com/doublethreedigital/cookie-notice/releases/tag/v5.0.0");
        }

        // Warn the user about user consent changes
        dump("[Cookie Notice] BREAKING CHANGE: Checking for user consent has changed, please see the v5.0.0 changelog. https://github.com/doublethreedigital/cookie-notice/releases/tag/v5.0.0");
    }
}
